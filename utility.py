...
class Utility:
    ...
    def draw_text2(self, x, y, text):
        display.draw_text(0 + y, 320 - x, self.reversed_string(text), self.font, color565(255,255,255), 0, True, True, 1)
    ...
    def menu(self):
        ...
        while True:
            ...
            if option != cur_option:
                display.clear()
                self.draw_text2(5, 5, f'>{options[option - 1]}')
                self.draw_text2(5, 30, f'{options[option]}')
